    ...
    render() {
      if (this.props.data.dealing == "logout" || this.state.dealing == "logout") {
        ...
        return (
          ...
          className="fa fa-area-chart"></i>Chart</a>
          ...
          <li>
          <a onClick={() => this.changeView('chart')} href="#chart"><i className="fa fa-area-chart"></i>Chart</a></li>
          <li className={this.state.selected == "table" ? 'active' : ''}>
          <a href="#table" onClick={() => this.changeView('table')}><i className="fa fa-th-list"></i>Transactions</a></li>
          </ul>
