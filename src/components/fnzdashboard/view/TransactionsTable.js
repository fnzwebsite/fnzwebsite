                ...
                LoadRows = Object.keys(self.props.dealingData).map(function (keyName, keyIndex) {
                    if (moment(self.props.dealingData[keyName].boxDate).isSame(today, 'd')) {
                        return <tr>
                            ...
                            <td className={self.props.dealingData[keyName].dealType == "BUY" ? "fund-blue" : "fund-orange"}>{self.props.dealingData[keyName].dealType}</td>
                            <td>{self.props.dealingData[keyName].units}</td>
                            <td>{self.props.dealingData[keyName].amount}</td>
                            <td><span
                                className={self.props.dealingData[keyName].dealingStatus == "ACCEPTED" ? "badge bg-green" : "badge bg-orange"}>{self.props.dealingData[keyName].dealingStatus}</span>
                            </td>
                        </tr>
                    }
                });
