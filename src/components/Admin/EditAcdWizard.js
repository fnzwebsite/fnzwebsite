...
render() {
//  alert(JSON.stringify(this.props.acdEditData));
  return (
    ...
    <label for="name">Name<label className="req">*</label></label>
    ...
    className={this.props.acdEditData.companyType=="FMA"?"btn btn-success":"btn"}
    data-toggle="button">
    Fund Manager
    </button>
    <button type="button" id="partialAML"   className={this.props.acdEditData.companyType=="FAA"?"btn btn-success":"btn"}>
    Fund
    Accountant
    </button>
    <button type="button" id="fullAML"   className={this.props.acdEditData.companyType=="TA"?"btn btn-success":"btn"}>
    Trustee
    </button>
    </div>
    ...
    <div className="form-group ">
    <div className="parsley-row uk-margin-top">
    <label for="registeredPostalCode">Postal code<span
    className="req">*</span></label>
