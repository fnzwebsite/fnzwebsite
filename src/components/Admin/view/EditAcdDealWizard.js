                                                ...
                                                <div className="form-group ">
                                                    <div className="parsley-row uk-margin-top">
                                                        <div className="select-option2">
                                                            <select id="ddlAccount" name="ddlAccount" className="form-control">
                                                ...
                                                <div className="form-group">
                                                        ...
                                                        <div className="parsley-row uk-margin-top">
                                                            <div className="md-input-wrapper">
                                                                ...
                                                                <input type="text" id="quantity" name="quantity" required=""
                                                                       className="md-input" data-parsley-id="4"/>
                                                    ...
                                                    <div className="parsley-row icheck-inline">
                                                        ...
                                                        <div className="btn-group" data-toggle="buttons-checkbox"
                                                             id="AMLBtnGroup1">
                                                            <button type="button" id="NotAML1" className="btn btn-success"
                                                                    data-toggle="button">
                                                                Amount
                                                            </button>
