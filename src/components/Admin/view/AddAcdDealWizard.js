...
render() {
  return (
    ...
    <select id="ddlAccount" className="form-control">
    ...
    <div className="parsley-row uk-margin-top">
    <div className="select-option2">
    <select id="ddlInstrument" name="ddlInstrument" className="form-control">
    ...
    <div className="parsley-row uk-margin-top">
    <div className="select-option2">
    <select id="fundCombo" className="form-control">
    ...
    <div className="form-group">
    <div className="parsley-row icheck-inline quan">
    <div className="parsley-row uk-margin-top">
    <div className="md-input-wrapper">
    <label for="quantity">Quantity<span className="req">*</span></label>
    <input type="text" name="quantity" required="" className="md-input" data-parsley-id="4"/>
    ...
    <div className="btn-group" data-toggle="buttons-checkbox" id="AMLBtnGroup1">
    <button type="button" id="NotAML1" className="btn btn-success" data-toggle="button">
    Amount
    </button>
    <button type="button" id="fullAML1" className="btn ">
    Units
    </button>
    ...
    <div className="form-group ">
    <div className="parsley-row uk-margin-top">
    <div className="select-option3">
    <select id="currencyCombo" name="currencyCombo" className="form-control">
    ...
    <label for="gender" className="clabel">Deal Type<span
    className="req">*</span></label>
    <div className="parsley-row icheck-inline">

    <div className="btn-group" data-toggle="buttons-checkbox"
    id="AMLBtnGroup">
    <button type="button" id="NotAML" className="btn btn-success" data-toggle="button">
    BUY
    </button>
