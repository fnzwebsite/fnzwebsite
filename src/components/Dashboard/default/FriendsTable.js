...
class FriendsTable extends Component {
    state = {
        data: [
            createData('John Smith', 'Co-Founder', 'http://via.placeholder.com/210x210', 'Followed'),
            createData('Alex Dolgove', 'CEO', 'http://via.placeholder.com/128x128', 'Follow'),
            createData('Domnic Brown', 'Co-Founder', 'http://via.placeholder.com/210x210', 'Followed'),
