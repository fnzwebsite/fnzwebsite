                            ...
                            <div className="navbar-header">
                                <ul className="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                    ...
                                    <li className="nav-item dropdown"><a id="notifications" rel="nofollow" data-target="#"
                                                                     ...
                                                                     className="nav-link"><i className="fa fa-bell-o"></i><span
                                        className="badge bg-yellow badge-corner">4</span></a>
                                    </li>
                                </ul>
                                <a href="" className="navbar-brand">
                                    <div className="brand-text brand-big"><img src="img/logo.png" alt="logo" className=""/>
                                    </div>
                                    <div className="brand-text brand-small"><img src="img/logo.png" alt="logo" className=""/>
                                    </div>
                                </a>
