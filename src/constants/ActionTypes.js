...
export const FETCH_ALL_DEALINGS = 'fetch_all_dealing';
export const FETCH_ALL_DEALINGS_SUCCESS = 'fetch_all_dealing_success';

export const FETCH_ACD_TODAY = 'FETCH_ACD_TODAY';
export const FETCH_ACD_TODAY_SUCCESS = 'FETCH_ACD_TODAY_SUCCESS';
export const FETCH_ACD_NEXT = 'FETCH_ACD_NEXT';
export const FETCH_ACD_NEXT_SUCCESS = 'FETCH_ACD_NEXT_SUCCESS';
export const FETCH_ACD_PREVIOUS = 'FETCH_ACD_PREVIOUS';
export const FETCH_ACD_PREVIOUS_SUCCESS = 'FETCH_ACD_PREVIOUS_SUCCESS';
